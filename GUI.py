...
if __name__ == "__main__":
    ...
    instruction_label = tk.Label(top_frame, text="Choose a number to run the corresponding query:", justify="left")
    ...
    run_query_button = tk.Button(top_frame, text="Run Query")
    ...
    asset_class_label = tk.Label(middle_frame, text="Asset Class:")
    ...
    insert_button = tk.Button(middle_frame, text="Insert Asset")
    insert_button.grid(row=0, column=2, padx=5, pady=5)
    # Insert Exchange
    exchange_label = tk.Label(middle_frame, text="Exchange:")
    ...
    insert_exchange_button = tk.Button(middle_frame, text="Insert Exchange")
    ...
    exit_button.grid(row=0, column=1, sticky="e", padx=10)
